        ...
        <div id="TopNav" class="w-[100%] h-[60px] fixed bg-black z-20 flex items-center justify-between">
                ...
                <div class="rounded-full flex items-center bg-[#222222] ">
                    <input
                        ...
                        class="
                            ...
                            focus:ring-0
                        "
                        placeholder="Made by Luka Otarashvili"
                    />
            ...
            <div>
                <img
                    ...
                    width="35"
                    src="https://yt3.ggpht.com/H7LIUfz_1y8UKo1k_vepHs_c1LoOOIYpw7fDsYjlIeSsDLIRQBtk3sML_1o3z79PE_SJeAvaKQ=s88-c-k-c0x00ffffff-no-rj"
                >
            </div>
        </div>
