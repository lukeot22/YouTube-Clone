<template>
    <div class="relative">
        <div 
            ...
            :class="[
                show && width > 639
                ? 'absolute z-30 trasitions ease-in-out delay-150 hover:translate-y-8 hover:scale-125 hover:bg-[#202020] duration-300'
                : ''
            ]"
        >
        ...
        <div class="flex">
            <div class="flex mt-1.5">
                <img
                    class="rounded-full m-1.5 mt-2 flex items-baselane w-8 h-8"
                    :src="image || ''"
                />
            </div>
